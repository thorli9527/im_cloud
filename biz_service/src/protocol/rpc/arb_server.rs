        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn update_shard_state(
            ...
            request: impl tonic::IntoRequest<
                super::super::arb_models::UpdateShardStateRequest,
            >,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_server.ArbServerRpcService/UpdateShardState",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "protocol.arb_server.ArbServerRpcService",
                        "UpdateShardState",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_server.ArbServerRpcService/RegisterNode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_server.ArbServerRpcService/ListAllNodes",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_server.ArbServerRpcService/GracefulLeave",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_server.ArbServerRpcService/heartbeat",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod arb_server_rpc_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/protocol.arb_server.ArbServerRpcService/ListAllNodes" => {
                    ...
                    impl<
                        T: ArbServerRpcService,
                    > tonic::server::UnaryService<super::super::arb_models::QueryNodeReq>
                    for ListAllNodesSvc<T> {
                        type Response = super::super::arb_models::ListAllNodesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::super::arb_models::QueryNodeReq,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
    ...
    pub const SERVICE_NAME: &str = "protocol.arb_server.ArbServerRpcService";
