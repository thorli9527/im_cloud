        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_socket.ArbSocketService/flushShardList",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "protocol.arb_socket.ArbSocketService",
                        "flushShardList",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_socket.ArbSocketService/flushSocketList",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod arb_socket_service_server {
    ...
    pub const SERVICE_NAME: &str = "protocol.arb_socket.ArbSocketService";
