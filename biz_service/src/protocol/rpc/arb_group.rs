        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_group.ArbGroupService/updateVersion",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "protocol.arb_group.ArbGroupService",
                        "updateVersion",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/protocol.arb_group.ArbGroupService/syncData",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("protocol.arb_group.ArbGroupService", "syncData"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod arb_group_service_server {
    ...
    pub const SERVICE_NAME: &str = "protocol.arb_group.ArbGroupService";
